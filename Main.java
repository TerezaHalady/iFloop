...
public class Main {
    ...
    public static void readIntsFromInputAndPrintItUntilNegative() {
        ...
        while (i >= 0) {
            ...
            // Pokud nechceš vypisovat, tak prostě smaž další řádek:
            // System.out.println("You entered: " + i);
        }
        System.out.println("Zadal jsi záporné číslo, program končí");
     ...
     */
    public static double sumAllInputUntilNegative() {
        ArrayList<Integer> seznamCisel = new ArrayList<>();
        int i = 0;
        while (i >= 0) {i = Support.safeReadInt(); System.out.println("You entered: " + i);
            seznamCisel.add(i);
        }
        seznamCisel.remove(seznamCisel.size()-1);
        int sum = 0;
        for(Integer s : seznamCisel)
            sum += s;
        return sum;
    ...
    public static List<Integer> storeAllInputInArrayListUntilNegative() {
        ...
        seznamCisel.remove(seznamCisel.size()-1);
        System.out.print("List zadaných hodnot, kromě hodnoty záporné "); return seznamCisel;
    ...
    public static void printAllIntegersFromList(List<Integer> list) {
        ...
        System.out.println("Výpis prvků: ");
        for (Integer i : list
